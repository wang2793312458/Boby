...
import com.example.boby.activity.OrderEditActivity;
...
import static com.example.boby.R.id.login_progress;
import static com.example.boby.R.id.rela_name;
import static com.example.boby.R.id.userpass;
    ...
    private void initView() {
        ...
        nextBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userphone.setBackground(getResources().getDrawable(R.drawable.bg_border_color_black));
                userphone.setBackground(getResources().getDrawable(R.drawable.bg_border_color_black));
